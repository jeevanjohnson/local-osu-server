...
CurrentOsuFileEntry = OsuFileEntryV1


class OsuFilesV1(MigratableModel):
    all: dict[str, CurrentOsuFileEntry] = Field(default_factory=dict)


CurrentOsuFiles = OsuFilesV1
